...
static zend_function_entry php_driver_function_methods[] = {
    PHP_ABSTRACT_ME(Function, name, arginfo_none) PHP_ABSTRACT_ME(Function, simpleName, arginfo_none)
        PHP_ABSTRACT_ME(Function, arguments, arginfo_none) PHP_ABSTRACT_ME(Function, returnType, arginfo_none)
            PHP_ABSTRACT_ME(Function, signature, arginfo_none) PHP_ABSTRACT_ME(Function, language, arginfo_none)
                PHP_ABSTRACT_ME(Function, body, arginfo_none)
                    PHP_ABSTRACT_ME(Function, isCalledOnNullInput, arginfo_none) PHP_FE_END};
